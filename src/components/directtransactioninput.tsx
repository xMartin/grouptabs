...
export default class DirectTransactionInput extends PureComponent<Props> {
  ...
  renderOptions() {
    return this.props.data.options.map((participant) => {
      ...
      return <option key={participant} value={value}>{label}</option>;
    });
  }
  ...
  render() {
    ...
    return (
      <div className='direct-transaction'>
        <div className='form-row' style={options.length > 1 ? undefined : {display: 'none'}}>
        ...
        <div className='form-row' style={from === NEW_PARTICIPANT_OPTION ? undefined : {display: 'none'}}>
          <div className='form-row-input'>
            <input
              type='text'
              placeholder='Name …'
        ...
        <div className='form-row' style={to === NEW_PARTICIPANT_OPTION ? undefined : {display: 'none'}}>
          <div className='form-row-input'>
            <input
              type='text'
              placeholder='Name …'
