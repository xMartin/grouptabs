    ...
    return (
      <form id='edit-entry-form' onSubmit={this.handleSubmit}>
        <div className='form'>
          <div className='form-row'>
            ...
            <div className='form-row-input transaction-type'>
              <select onChange={this.handleSelectTransactionType} value={data.transactionType}>
          ...
          >
            ...
            <div className='form-row'>
              <div className='form-row-input'>
                <button type='button' onClick={this.props.onAddParticipant}>+ new participant</button>
                <button type='button' className='all-joined' onClick={this.props.onSetAllJoined}>all joined</button>
              </div>
            </div>
          </div>
        </div>
        <div className={'row' + (mode === 'edit' ? ' button-row' : '')}>
          {mode === 'edit' ?
            <span className='fake-link delete' onClick={this.handleDelete}>Delete transaction</span>
            : null
          }
        </div>
      </form>
